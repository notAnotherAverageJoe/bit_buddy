...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://joseph:9k4o7SJ4DbwybATEzPqnkjzI5fJkLTmd@dpg-cp8cd48l6cac73c2f7l0-a.oregon-postgres.render.com/bitbuddy"
        ...
        try:
            ...
            if user:
                new_transaction = TransactionHistory(
                    user_id=user_id,
                    cryptocurrency_id=1,  # Hardcoded for Bitcoin
...
def bitcoin_sell():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error_message = "Invalid amount entered. Please enter a valid number."
            return render_template('/users/bitcoin_sell.html', bitcoin_price=bitcoin_price, bitcoin_symbol=bitcoin_symbol, error_message=error_message)
    else:
